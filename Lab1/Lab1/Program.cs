...
namespace Lab1
{
    ...
    class WeatherData : IComparable<WeatherData>, ICloneable<WeatherData>, Values
    {
        public string Time;
        public int T;
        public int? P0;
    ...
    class BinarySearchTree<T> where T : IComparable<T>, ICloneable<T>
    {
        private Node head;
        private class Node
        {
    ...
    static class Sort<T> where T : IComparable<T>, ICloneable<T>, Values
    {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //}
            //var array = JsonConvert.DeserializeObject<List<WeatherData>>(str);
            ...
            //var ar = JsonConvert.DeserializeObject<List<WeatherData>>(str);
